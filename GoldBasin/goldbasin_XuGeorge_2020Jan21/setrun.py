...
#------------------------------
    ...
    boundaryfile = os.path.join('init_data','topo','topodomain_w_riverbed.tt3')
...
def setgeo(rundata):
    ...
    fname = os.path.join(topopath,'topodomain_w_riverbed.tt3')
    topotype = 3
    minlevel =1
    maxlevel = 4
    ...
    fname = os.path.join(topopath,'m0_init_landslide_0.62.tt3')
    topotype = 3
