...
gt.topo2writer(outfile,MedCap_eta,xlower,xupper,ylower,yupper,nxpoints,nypoints)

# initial depth
outfile= 'MedCap_eta_bn.tt2'
outfile = os.path.join(qinitdir,outfile)
dx = 0.001 #1 mm DEM
# grid
xlower =  0.0
...
nxpoints = int((xupper-xlower)/dx) + 1
nypoints = int((yupper-ylower)/dx) + 1
gt.topo2writer(outfile,MedCap_eta_bn,xlower,xupper,ylower,yupper,nxpoints,nypoints)


# initial depth
outfile= 'MedCap_b_23.tt2'
...
nxpoints = int((xupper-xlower)/dx) + 1
nypoints = int((yupper-ylower)/dx) + 1
gt.topo2writer(outfile,MedCap_b,xlower,xupper,ylower,yupper,nxpoints,nypoints)
