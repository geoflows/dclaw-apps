...
def setgeo(rundata):
    ...
    minlevel = 1
    maxlevel = 4
    topopath = os.path.join(topo,'Baker','dems_from_charlie','FinnFig9_de1_ascii')
    infile = os.path.join(topopath,'finnfig9_de1_topo_with_slip_surface.tt3')
    geodata.topofiles.append([topotype,minlevel,maxlevel, -1.0, 1.e10, infile])
    ...
    # Finn landslide source
    topotype = 3
    minlevel = 3
    maxlevel = 3
    eta0n = 8
    topopath = os.path.join(topo,'Baker','dems_from_charlie','FinnFig9_de1_ascii')
    initfile = os.path.join(topopath,'finnfig9_de1_src_topo.tt3')
